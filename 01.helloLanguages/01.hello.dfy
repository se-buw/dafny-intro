module {:extern "helloworld"} HelloWorld {

  class HelloWorldMachine {

    static method GetHelloWorld(langCode: string) returns (greeting: string)
...
method Main() {
  ...
  var myGreeting := HelloWorld.HelloWorldMachine.GetHelloWorld("es");
  print myGreeting;
